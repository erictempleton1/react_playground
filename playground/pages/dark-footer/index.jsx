    ...
    <div className={styles.Content__Container}>
      ...
      <footer className={styles.Content__Footer}>
        ...
        <div className={styles.Footer__Column}>
          <div className={styles.Column__Header}>Solutions</div>
          <a href="#analytics" className={styles.Column__Link}>Analytics</a>
          <a href="#marketing" className={styles.Column__Link}>Marketing</a>
          <a href="#innotivation" className={styles.Column__Link}>Innovation</a>
          <a href="#onboarding" className={styles.Column__Link}>On Boarding</a>
          <a href="#development" className={styles.Column__Link}>Development</a>
        </div>

        <div className={styles.Footer__Column}>
          <div className={styles.Column__Header}>Support</div>
          <a href="#pricing" className={styles.Column__Link}>Pricing</a>
          <a href="#apidocs" className={styles.Column__Link}>API Docs</a>
          <a href="#examples" className={styles.Column__Link}>Examples</a>
        </div>

        <div className={styles.Footer__Column}>
          <div className={styles.Column__Header}>Company</div>
          <a href="#about" className={styles.Column__Link}>About</a>
          <a href="#blog" className={styles.Column__Link}>Blog</a>
...
function YouTubeIcon() {
  return (
    <svg className={styles.Social__Icon} role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>YouTube icon</title><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
  );
}
